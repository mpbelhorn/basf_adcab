...
int compareFinalStates(std::vector<Gen_hepevt> reconstructed,
    std::vector<Gen_hepevt> generated);
void fillMothers(Particle &p, std::vector<int> &thisMothers,
    std::vector<int> &otherMothers);
void fillMothers(Particle &A, Particle &B, std::vector<int> &thisMothers,
    std::vector<int> &otherMothers);
...
int findCommonMother(int nChildren, std::vector<int> thisMothers,
    std::vector<int> otherMothers);
